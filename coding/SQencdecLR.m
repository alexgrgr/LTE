function [i,y]=SQencdecLR(x,x_vec,y_vec);
% SQencdecLR	Scalar quantizer for variable X, with quantizer 
...
% Note:
%		If x=negative at the boundary point favor to left (more negative)
%		If x=positive at the boundary point favor to right (more positive)
%
