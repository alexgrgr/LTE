function [txWaveform, txBits, txCW]= lteTx1(txInfo, enb, subframes, params)
...
for n=1:txInfo.TotSubframes
    ...
    fprintf('DCI Information on transmit signal:\n ');
    disp(dciMessage)
    ...
    %% Generate synchronization signals and add them
    ...
    if n == 1
        ...
        resourceGrids = [resourceGrids subframe];
    end
end
