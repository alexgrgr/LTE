...
switch params.WaveMod
    case 'FOFDM'
        txWaveform = commExamplePrivate('lteFOFDMTx', ...
                            subframe, ...
                            enb.NDLRB, enb.FiveG.FOFDM.FilterLenght, ...
                            enb.FiveG.FOFDM.toneOffset);
    case 'UFMC'
        txWaveform = commExamplePrivate('lteUFMCTx', ...
            subframe,...
            enb.NDLRB,...
            enb.FiveG.UFMC.slobeAtten);
end